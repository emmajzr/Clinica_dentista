...
use App\Http\Controllers\DashboardController; // Asegúrate de importar el controlador PacientesController
use App\Http\Controllers\DentistasController; // Asegúrate de importar el controlador DentistasController
use App\Http\Controllers\PacientesController; // Asegúrate de importar el controlador AdminController
use App\Http\Controllers\ProfileController; // Asegúrate de importar el controlador DashboardController
