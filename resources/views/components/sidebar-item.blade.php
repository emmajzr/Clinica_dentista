...
>
    ...
    <span class="sidebar-item-text whitespace-nowrap"> {{ $slot }} </span>

    {{-- Tooltip para cuando está colapsado --}}
    <div
        class="sidebar-tooltip hidden group-hover:block absolute left-full ml-2 px-2 py-1 bg-slate-800 text-white text-xs rounded whitespace-nowrap z-50 shadow-lg"
    >
        {{ $slot }}
    </div>
</a>
