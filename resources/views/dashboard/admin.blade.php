...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="#" class="text-cyan-600 text-sm hover:underline">Ver todas</a>
            </div>
            <div class="space-y-3">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">
                                <i class="fas fa-tooth mr-1"></i> Dra. Laura Martínez
                            </p>
                        </div>
                    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="#" class="text-cyan-600 text-sm hover:underline">Ver todos</a>
        </div>
            ...
            <table class="w-full">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="text-left p-3 text-xs font-semibold text-gray-500">Última cita</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition">
                        ...
                        <td class="p-3 text-sm text-gray-600">maria@email.com</td>
                        <td class="p-3 text-sm text-gray-600">+51 987 654 321</td>
                        <td class="p-3 text-sm text-gray-600">2024-01-15</td>
                        <td class="p-3">
