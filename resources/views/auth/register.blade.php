<x-guest-layout>
    <div class="text-center mb-8">
        ...
        <p class="mt-2 text-gray-600 dark:text-gray-400">Crea tu cuenta</p>

        <p class="text-sm text-gray-500 dark:text-gray-400">Regístrate para acceder al sistema dental.</p>
    </div>
