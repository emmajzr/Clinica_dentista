...
<body class="bg-gradient-to-r from-cyan-100 via-white to-blue-100 min-h-screen">
    ...
    <header class="flex justify-between items-center p-6">
        <div class="flex items-center gap-3">
            <div
                class="bg-cyan-600 text-white w-12 h-12 rounded-full flex items-center justify-center text-2xl"
            >
                🦷
            </div>
            ...
            <div>
                ...
                <p class="text-gray-500 text-sm">Tu sonrisa es nuestra prioridad</p>
            </div>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
                <h2 class="text-5xl font-bold text-gray-800 leading-tight mb-6">
                    Bienvenido a
                    <span class="text-cyan-600"> Clínica Dental Belinda </span>
                </h2>

                <p class="text-lg text-gray-600 mb-8">Brindamos atención dental profesional, moderna y confiable para cuidar tu salud bucal y devolverte la mejor sonrisa.</p>
            ...
            <div class="flex justify-center">
                <div class="bg-white shadow-2xl rounded-3xl p-10 max-w-md">
                    <div class="text-center">
                        ...
                        <p class="text-gray-600 mb-6">Agenda tus consultas, administra tu perfil y lleva un mejor control de tu atención dental.</p>
